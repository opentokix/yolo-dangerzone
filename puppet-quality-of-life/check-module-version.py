...
@click.command()
@click.option('--name', '-N', required=False, default=None, help="The module you want version of")
...
@click.option('--file', '-f', 'puppetfile', required=False, default=None, help="Print out a complete upgraded Puppetfile")
